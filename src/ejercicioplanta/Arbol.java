...
public class Arbol extends Planta {
    ...
    public Arbol(String variedad, String tipoTronco, double radioTronco, String color, String tipoHojas, String nombre, double altodelTallo, boolean tieneHojas, String climaIdeal) {
